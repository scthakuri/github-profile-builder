...
function Navbar() {
    ...
    const fetchData = async () => {
        if (shouldRequestStats()) {
            await axios.get('https://api.github.com/repos/sureshchand12a/github-profile-builder').then((response) => {
    ...
    return (
        <div className="header_container">
            ...
            <div className="header_container_star_container">
                <a href="https://github.com/sureshchand12a/github-profile-builder" aria-label="Star sureshchand12a/github-profile-builder on GitHub" target="blank" className="mr-2">
                ...
                <a href="https://github.com/sureshchand12a/github-profile-builder/fork" aria-label="Fork sureshchand12a/github-profile-builder on GitHub" target="blank">
                    <div className="repo_container">
